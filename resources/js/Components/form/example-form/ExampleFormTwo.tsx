      ...
      <Form onSubmit={handleSubmit}>
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="col-span-2">
            ...
            <div className="relative flatpickr-wrapper w-fit">
              <Flatpickr
                ...
                className="w-full py-2 pl-3 pr-10 text-sm border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:border-gray-700 dark:text-white"
              />
