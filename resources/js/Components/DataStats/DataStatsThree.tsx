    ...
    <div>
      <div className="mb-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center">
          <p className="font-medium uppercase text-black dark:text-white mr-3">
            Sortiraj:
          </p>
        ...
        <div className="xl:p-7.5 rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
          <div className="flex items-end justify-between">
            <div className='flex items-center'>
              ...
              <p className="font-medium mb-2 ml-1">Polaznika</p>
        ...
        <div className="xl:p-7.5 rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-medium">Računa izdano</p>
              <span className="mt-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Za tekući mjesec</span>
              </span>
            </div>
