...
export default function Create({ template, placeholders, type, isEdit = false }) {
    const { data, setData, post, patch, processing, errors } = useForm({
        type: template?.type || type || "privola",
        name: template?.name || "",
    ...
    const handleSubmit = (e) => {
        ...
        submitMethod(routeName, {
            ...
            onSuccess: () => {
                ...
                router.visit(route("document-templates.privole.index"));
            },
            onError: () => {
    ...
    return (
        <AuthenticatedLayout>
            ...
            <Breadcrumb
                pageName={
                    isEdit ? "Uredi predložak privole" : "Novi predložak privole"
                }
            />
            <ComponentCard title={isEdit ? "Uredi predložak" : "Novi predložak"}>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Link
                            href={route("document-templates.privole.index")}
